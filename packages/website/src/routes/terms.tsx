...
export function meta() {
  return [
    { title: "Terms of Service - Last Light" },
    {
      name: "description",
      content: "Terms of service for Last Light game.",
    },
  ];
}
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              By accessing and playing Last Light ("the Game"), you accept and agree to be bound
          ...
          <section>
            ...
            <p>
              Last Light is a free-to-play multiplayer online survival game. We reserve the right
